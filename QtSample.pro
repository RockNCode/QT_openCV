...
else:win32:LIBS += -L$$MYWINOPENCVPATH/build/x64/vc12/lib -lopencv_core249 -lopencv_highgui249 -lopencv_imgproc249 \
            INCLUDEPATH += $MYWINDOWSOPENCVPATH/build/build/include
